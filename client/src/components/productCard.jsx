...
function ProductCard({ product }) {
  ...
  return (
    <article
      onClick={handleClick}
      className="group flex h-full min-w-0 cursor-pointer flex-col overflow-hidden rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-[0_5px_16px_rgba(15,23,42,0.07)]"
    >
      {/* Product Image */}
